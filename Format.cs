...
public static class Format
{
    ...
    public static string Command(this string input) => Bold(input).Color(KinPonds.Color.Command);
    public static string Role(this string input) => Bold(input).Color(KinPonds.Color.DarkGreen);
    public static string User(this string input) => Bold(input).Color(KinPonds.Color.Orange);
